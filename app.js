...
// ==========================================
// IMPORTANT: Update the 'artist' field with the real student names!
...
const PAGES = [
  ...
  { id:'material_explore', title:'Material Explore', artist:'Des. by Emma', imgUrl:'', emoji:'🧱', color:'#78716c' },
  ...
  // --- DESIGN & CRAFT ---
  { id:'interior_design', title:'Interior Design', artist:'Des. by Chloe', imgUrl:'', emoji:'🛋️', color:'#d97706' },
  { id:'costume_design', title:'Costume Design', artist:'Des. by Max', imgUrl:'', emoji:'👗', color:'#db2777' },
  { 
    id:'hand_crafter', 
    title:'Hand Crafter', 
    artist:'Des. by Xinyue', 
  ...
  // --- DIGITAL & FUTURE ---
  { id:'digital_creator', title:'Digital Creator', artist:'Des. by Sam', imgUrl:'', emoji:'💻', color:'#0ea5e9' },
  { id:'animation_beginner', title:'Animation Beginner', artist:'Des. by Serena', imgUrl:'', emoji:'🎞️', color:'#8b5cf6' },
  { id:'gaming_creator', title:'Gaming Creator', artist:'Des. by Nick', imgUrl:'', emoji:'🎮', color:'#a855f7' },
  ...
  { id:'fei_volunteer', title:'Volunteer', artist:'Des. by Fei', imgUrl:'', emoji:'🤝', color:'#14b8a6' },
